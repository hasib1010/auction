    ...
    <div className="bg-gray-50">
      <div>
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          {/* Auction Site Card */}
          <div className="border-r border-gray-100 p-8 flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 ml-7 h-full py-3">
              ...
              <button className="linear-gradient text-white px-8 py-3 rounded-full text-[16px] font-semibold transition-colors flex items-center space-x-2.5">
                <span>
                  <Link href="/auction">Explore Auctions</Link>
                </span>
          ...
          <div className="border-l border-gray-100 py-8 px-7 flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 ml-8 h-full">
              <div className='flex flex-col justify-between h-full py-8'>
                ...
                <div>
                  <button className="bg-black hover:bg-gray-800 text-white px-8 py-3 rounded-full text-[16px] font-semibold transition-colors flex items-center space-x-2.5">
                    <span>
