        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="border-r border-gray-100 md:p-8 py-4 flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 ml-7 h-full py-3">
              ...
              <Link href="/auction">
                <button className="linear-gradient text-white px-8 py-3 mx-auto md:mx-0 rounded-full text-[16px] font-semibold transition-colors flex items-center space-x-2.5">
                  <span>
                    Explore Auctions
                  </span>
          ...
          <div className="border-l border-gray-100 py-8 px-7 flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 ml-8 h-full">
              <div className='flex flex-col justify-between h-full py-8'>
                ...
                <div>
                  <Link href="/store">
                    <button className="bg-black hover:bg-gray-800 mx-auto md:mx-0 text-white px-8 py-3 rounded-full text-[16px] font-semibold transition-colors flex items-center space-x-2.5">
                      <span>
                        Visit Store
                      </span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="17" viewBox="0 0 10 17" fill="none">
