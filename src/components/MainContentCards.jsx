    ...
    <div className="bg-gray-50">
      <div>
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          {/* Auction Site Card */}
          <div className="border-r border-gray-100 md:p-8 py-4 flex flex-col md:flex-row items-center mt-8 md:mt-0">
            ...
            {/* Content */}
            <div className="flex-1 md:ml-7 h-full py-3">
          ...
          {/* The Store Card */}
          <div className="border-l border-gray-100 md:py-8 md:px-7 flex flex-col md:flex-row items-center">
            {/* Character Illustration */}
            <div className="flex flex-1 items-center justify-center bg-gray-100 px-14 md:px-9 py-9 rounded-4xl">
