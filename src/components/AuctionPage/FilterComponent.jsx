...
export default function FilterComponent() {
    ...
    return (
        <div className='md:w-80 border-[#E3E3E3] md:border-r-[1px] md:pr-5'>
            {/* icons and text */}
            ...
            {/* filter options */}
            <div>
                <div className='flex justify-between' onClick={toggleDropdownLocation}>
                ...
                {isOpenLocation && (
                    <div className="relative mt-3">
                        <select
                            ...
                            className="w-full px-4 py-3.5 rounded-lg border-[1px] border-[#E3E3E3] bg-[#F7F7F7] focus:outline-none focus:ring-2 focus:ring-purple-300 text-sm text-[#4D4D4D] appearance-none"
                        >
                ...
                {/* category picker */}
                <div className='flex justify-between my-5' onClick={toggleDropdownCategory}>
                ...
                {/* date range */}
                <div className='flex justify-between my-5' onClick={toggleDropdownDateRange}>
                ...
                {/* Auction status */}
                <div className='flex justify-between my-5' onClick={toggleDropdownAuctionStatus}>
                    ...
                    {isOpenPriceRange && (
                        <div>
                            <Slider
                                ...
                                trackStyle={[{ backgroundColor: '#9F13FB' }]}
                                handleStyle={[
                                    { backgroundColor: '#9F13FB', border: 'none' },
                                    { backgroundColor: '#9F13FB', border: 'none' }
                                ]}
                            />
                            <div className="flex justify-between mt-5 text-sm font-medium">
                                <div>
                                    ...
                                    <span className="border border-[#E3E3E3] bg-[#F7F7F7] px-3 py-2 rounded-lg">{range[0]}</span>
                                </div>
                                <div>
                                    <span className="mr-2">Max</span>
                                    <span className="border border-[#E3E3E3] bg-[#F7F7F7] px-3 py-2 rounded-lg">{range[1]}</span>
                                </div>
                            </div>
                        </div>
                    )}
